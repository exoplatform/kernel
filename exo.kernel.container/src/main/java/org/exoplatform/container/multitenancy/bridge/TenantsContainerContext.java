...
public interface TenantsContainerContext
{
    ...
    *
    * @param componentKey {@link Object} key of a component
    ...
    */
   <T> boolean accept(ComponentAdapter<T> adapter );
    ...
    */
   <T> ComponentAdapter<T> registerComponent(ComponentAdapter<T> component) throws TenantComponentRegistrationException;
