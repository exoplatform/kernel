 ...
 * <a href="http://www.w3.org/TR/NOTE-datetime">ISO 8601</a>). <br> The currently
 * supported format is:
 * 
 * <pre>
...
public final class ISO8601ASF
{
   ...
   public static Calendar parse(String text)
   {
       ...
       * java.text.SimpleDateFormat for parsing because it can't handle years <= 0
       * and TZD's
       */
   ...
   public static String format(Calendar cal)
   {
      ...
      {
         /**
          * calculate year using astronomical system: year n BCE => astronomical
          * year -n + 1
          */
         year = 0 - year + 1;
      }
      ...
      /**
       * the format of the date/time string is: YYYY-MM-DDThh:mm:ss.SSSTZD note
       * that we cannot use java.text.SimpleDateFormat for formatting because it
       * can't handle years <= 0 and TZD's
       */
